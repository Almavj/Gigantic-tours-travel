...
const KenyanDestinationsPage: NextPage = () => {
  const [filtered, setFiltered] = useState<Destination[]>(kenyanDestinations);
  const categories: string[] = [...new Set(kenyanDestinations.flatMap((dest: Destination) => dest.category))];
    ...
    <>
      ...
      <main className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <CategoryFilter categories={categories} destinations={kenyanDestinations} onFilterChange={setFiltered} />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map((destination: Destination) => (
...
export default KenyanDestinationsPage;
