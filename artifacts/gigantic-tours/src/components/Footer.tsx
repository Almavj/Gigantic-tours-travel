...
import { NavItem } from '../types/destination';
...
const Footer = ({ navItems = [] }: FooterProps) => {
  const defaultNavItems: NavItem[] = [
    ...
    { name: 'Tours', href: '/destinations/kenya' },
    { name: 'Special Offers', href: '/destinations' }
  ];
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0 flex items-center space-x-3">
            <Link href="/" className="flex items-center space-x-2 group">
              <img src="/logos/GTT-LOGO.png" alt="Gigantic Tours & Travel Logo" className="h-8 w-auto object-contain transition-transform group-hover:scale-105" style={{maxWidth:'40px'}} onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
