...
export default function BookingForm({ destination, onClose }: BookingFormProps) {
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 pl-10 border py-2 px-3"
                    required
                  />
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="flex justify-between pt-2">
                ...
                <span className="font-bold text-blue-600">
                  ${((packages.find(p => p.id === bookingData.package)?.price ?? 0) * bookingData.guests).toLocaleString()}
                </span>
              </div>
            </div>
