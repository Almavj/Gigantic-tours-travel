...
const About = () => {
  ...
  const teamMembers: TeamMember[] = [
    { id: 1, name: 'Victory Wanjiku', role: 'Founder & CEO', bio: 'With over 15 years in the travel industry, Victory founded Gigantic Tours & Travel to share her passion for authentic travel experiences.', image: '/images/image1.jpeg' },
    { id: 2, name: 'Allan Macharia', role: 'Head of Operations', bio: 'Allan ensures every trip runs smoothly with his exceptional organizational skills and attention to detail.', image: '/images/team2.jpeg' },
    { id: 3, name: 'Steve White', role: 'Travel Expert', bio: 'Steve has visited over 60 countries and brings unparalleled destination knowledge to our team.', image: '/images/team3.jpeg' },
    { id: 4, name: 'Careb Kimani', role: 'Customer Experience', bio: 'Careb makes sure every traveler feels valued and supported throughout their journey.', image: '/images/team4.jpeg' }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      <Navbar />
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 pt-28">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl">About Us</h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Founded in 2020, Gigantic Tours & Travel began as a small team of travel enthusiasts with a big dream: to make world-class travel experiences accessible to everyone.
            </p>
            <p className="text-gray-600 mb-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map(member => (
              <div key={member.id} className="text-center">
                <div className="mx-auto h-40 w-40 rounded-full overflow-hidden mb-4 bg-gray-200">
                  <img
        ...
        <div className="bg-blue-700 rounded-xl p-8 text-white mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <ul className="space-y-4">
              {['Expert-curated itineraries designed by travel specialists', '24/7 customer support during your travels', 'Local guides who provide authentic experiences'].map((item, i) => (
                <li key={i} className="flex items-start">
                  <svg className="h-5 w-5 text-green-400 mr-2 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <ul className="space-y-4">
              {['Flexible booking options and payment plans', 'Sustainable travel practices that support communities', 'Best price guarantee for all our packages'].map((item, i) => (
                <li key={i} className="flex items-start">
                  <svg className="h-5 w-5 text-green-400 mr-2 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
        ...
        <div className="text-center">
          ...
          <Link href="/contact" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-md text-lg font-medium">
